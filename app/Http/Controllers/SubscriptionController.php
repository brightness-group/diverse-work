...
class SubscriptionController extends Controller
{
    ...
    public function submitAlert(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            $subscription->salary_offered_ids = $request->get('salary_offered_ids');
            $subscription->job_type_ids = $request->get('job_type_ids');
            $subscription->career_level_ids = $request->get('career_level_ids');
            $subscription->job_experience_ids = $request->get('job_experience_ids');
            $subscription->degree_level_ids = $request->get('degree_level_ids');
