...

{
...

    {
        ...
        if ($request->hasFile('image2')) {
            $this->deleteSiteSettingImage($id,true);
            $alternate_image = ImgUploader::UploadImage('sitesetting_images', $request->file('image2'), $image_name.' ');
            $siteSetting->alternate_site_logo = $alternate_image;
        }
        ...
        $siteSetting->footer_short_desc = $request->input('footer_short_desc');
    ...
    private function deleteSiteSettingImage($id, $alternate = false)

    {
        ...
        try {
            ...
            $image = $alternate ? $siteSetting->alternate_site_logo : $siteSetting->image;
