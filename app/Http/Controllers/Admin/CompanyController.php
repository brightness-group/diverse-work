...
class CompanyController extends Controller
{
    ...
    public function editCompany($id)
    {
        ...
        if (isset($company->package_end_date) && !is_null($company->package_end_date)) {
            $company->package_end_date = Carbon::createFromFormat('Y-m-d h:i:s', $company->package_end_date)->format('Y-m-d');
        }
    ...
    public function updateCompany($id, CompanyFormRequest $request)
    {
        ...
        if ($request->has('jobs_quota') && ($request->has('package_end_date'))) {
            $company->package_end_date = $request->input('package_end_date');
            $company->jobs_quota = $request->input('jobs_quota');
            $company->availed_jobs_quota = $request->input('availed_jobs_quota');
