...
class DataArrayHelper
{
    ...
    public static function countryWiseCitiesArray($sort_name)
    {
        $countryDetail = CountryDetail::where('sort_name', $sort_name)->first();
        $country = $countryDetail->getCountry();
        $states = State::where('country_id', $country->id)->pluck('id');

        $array = City::select('cities.city', 'cities.city_id')->whereIn('cities.state_id', $states->toArray())->isDefault()->active()->sorted()->pluck('cities.city', 'cities.city_id')->toArray();
        return $array;
    }
    ...
    public static function langSalaryOfferedArray()
    {
        $array = [
            '1' => 'Under €10,000',
            '2' => '€10,000 - €15,000',
    ...
    public static function defaultSalaryOfferedArray()
    {
        $array = [
            '1' => '0-10000',
            '2' => '10000-15000',
