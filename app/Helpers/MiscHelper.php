...
class MiscHelper
{
    ...
    {
        return \App\Job::where('is_active',1)->notExpire()->get();
    }

    public static function unique_slug($string,$table,$field='slug',$key=NULL,$value=NULL)
    {
        $slug = Self::url_title($string);
