...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
			...
			{!! Form::text('date_of_birth', $user->date_of_birth->format('Y-m-d'), array('class'=>'datepicker form-control', 'id'=>'date_of_birth', 'placeholder'=>__('Date of Birth'), 'autocomplete'=>'off')) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
            <label for="">{{__('Date of Birth')}}</label>
            {!! Form::text('date_of_birth', '', array('class'=>'datepicker form-control', 'id'=>'date_of_birth', 'placeholder'=>__('Date of Birth'), 'autocomplete'=>'off')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'date_of_birth') !!} </div>
    </div>
    @endif
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'national_id_card_number') !!}">
			<label for="">{{__('National ID Card#')}}</label>
...
<div class="card">
<div class="card-header">
                                <h4 class="title">{{__('Career Information')}}</h4>
                            </div>
                            <div class="card-body">
...
<div class="row">
 <div class="col-md-6">
    ...
    <div class="col-md-12">
    <div class="mb-1 formrow {!! APFrmErrHelp::hasError($errors, 'is_subscribed') !!}">
    <?php
    ...
    <!-- <div class="row"> -->
        <div class="col-md-12">
            <div class="mb-1 formrow {!! APFrmErrHelp::hasError($errors, 'is_resume_downloadable') !!}">
            <?php
            $is_checked = 'checked="checked"';	
            if (old('is_resume_downloadable', ((isset($user)) ? $user->is_resume_downloadable : 1)) == 0) {
                $is_checked = '';
            }
            ?>
            <input type="checkbox" value="1" name="is_resume_downloadable" {{$is_checked}} />
            {{__('Is resume downloadable?')}}
            {!! APFrmErrHelp::showErrors($errors, 'is_resume_downloadable') !!}
        </div>
    <!-- </div> -->
    <div class="col-md-12">
        <div class="formrow"><button type="submit" class="btn theme-btn">{{__('Update Profile and Save')}}  <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button></div>
    </div>
</div>
