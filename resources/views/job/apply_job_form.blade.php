...
<!-- Header end --> 
@include('includes.inner_page_common_title', ['page_title'=>__('Apply on Job')])
    <div class="container"> @include('flash::message')
        <section class="padd-top-60 padd-bot-60">
            <div class="container">
                <!-- row -->
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="userccount">
                            <div class="formpanel"> {!! Form::open(array('method' => 'post', 'route' => ['post.apply.job', $job_slug])) !!} 
                                <!-- Job Information -->
                                <h4><h4 class="meg-0">{{$job->title}} at {{$company->name}} in {{$job->getCity('city')}}</h4></h4>
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <input type="submit" class="btn btn-job theme-btn white apply" value="{{__('Apply on Job')}}">
                                </div>
