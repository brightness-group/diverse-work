...
@include('includes.inner_page_common_title', ['page_title'=>__('Report Abuse')])
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="userccount">
                    {!! Form::open(array('method' => 'post', 'route' => ['report.abuse', $slug])) !!}
                        @csrf
                        ...
                        <div class="formpanel">
                            ...
                            <div class="form-group mb-3">
                                <input type="submit" id="post_ad_btn" class="btn theme-btn" value="{{__('Report')}}">
                            </div>
                        </div>
                    {!! Form::close() !!}
                </div>
