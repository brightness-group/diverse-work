...
<div class="wrapper">
    ...
    @include('includes.inner_page_common_title', ['page_title'=>__('All Companies')])
    <!-- Inner Page Title end -->
            ...
            <section id="joblisting-header" role="search" class="searchform">
                <form id="top-search" method="GET" action="{{route('company.listing')}}">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <button type="submit" id="submit-form-top" class="btn w-100 theme-btn"><i class="fa fa-search" aria-hidden="true"></i> {{__('Search Company')}}</button>
                        </div>
                    </div>
                </form>
            </section>
