...
<div class="listpgWraper">
                        ...
                        <div id="candidate" class="formpanel tab-pane {{($c_or_e == 'candidate')? 'active':''}}">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="formrow{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                    ...
                                    <div class="checkbox-row formrow{{ $errors->has('is_subscribed') ? ' has-error' : '' }}">
    ...
    <input type="checkbox" value="1" id="check1" name="is_subscribed" {{$is_checked}} />  <label for="check1">{{__('Subscribe to news letter')}}</label>
                                ...
                                <div class="checkbox-row formrow{{ $errors->has('terms_of_use') ? ' has-error' : '' }}">

                                <span class="custom-checkbox">
    <input type="checkbox" value="1" name="terms_of_use" />  <label for=""> <a href="{{url('cms/terms-of-use')}}">{{__('I accept Terms of Use')}}</a></label>
                                ...
                                <input type="submit" class="btn mt-2" value="{{__('Register')}}">
...
<span class="custom-checkbox">
    ...
    <input type="checkbox" value="1" name="terms_of_use" />  <label for=""> <a href="{{url('cms/terms-of-use')}}">{{__('I accept Terms of Use')}}</a></label>
                    ...
                    <div class="newuser"><i class="login-icon ti-user" aria-hidden="true"></i> {{__('Have Account')}}? <a href="{{route('login')}}">{{__('Sign in')}}</a></div>
